...
public class Block extends Mold implements Intersectable 
{
    ...
    //used for testing not incoorporated in finished proiject
    public void print(Block block)
    {
        System.out.println("Object is at" + block.getxPos()+ " , " + block.getyPos() );
    }
